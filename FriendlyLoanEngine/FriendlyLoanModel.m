...
#import "FriendlyLoanModel.h"


@implementation FriendlyLoanModel
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:self.persistentStoreName];
...
//{
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"FriendlyLoan.sql"];
//    NSError *error;
