//
//  LoansWaitingForLocationFetchRequest.m
//  FriendlyLoan
//
...
@implementation LoansWaitingForLocationFetchRequest
...
+ (NSArray *)fetchFromManagedObjectContext:(NSManagedObjectContext *)managedObjectContext
{
    ...
    NSDictionary *variables = [NSDictionary dictionaryWithObject:dateLimit forKey:@"dateLimit"];
    NSFetchRequest *fetchRequest = [managedObjectModel fetchRequestFromTemplateWithName:@"LoansWaitingForLocationFetchRequest" substitutionVariables:variables];
