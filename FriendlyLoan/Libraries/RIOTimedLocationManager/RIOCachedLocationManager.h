...
@protocol RIOTimedLocationManagerDelegate;

@interface RIOTimedLocationManager : NSObject

// Delegate
@property (nonatomic, weak) id<RIOTimedLocationManagerDelegate> delegate;
